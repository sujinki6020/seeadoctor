...
public class Hospital {
	...
	public String toString() {
		return "Hospital [hospitalSeq=" + hospitalSeq + ", qd=" + qd + ", rnum=" + rnum + ", dutyAddr=" + dutyAddr
				+ ", dutyDiv=" + dutyDiv + ", dutyDivNam=" + dutyDivNam + ", dutyEmcls=" + dutyEmcls
				+ ", dutyEmclsName=" + dutyEmclsName + ", dutyEryn=" + dutyEryn + ", dutyEtc=" + dutyEtc
				+ ", dutyMapimg=" + dutyMapimg + ", dutyName=" + dutyName + ", dutyTel1=" + dutyTel1 + ", dutyTel3="
				+ dutyTel3 + ", dutyTime1c=" + dutyTime1c + ", dutyTime2c=" + dutyTime2c + ", dutyTime3c=" + dutyTime3c
